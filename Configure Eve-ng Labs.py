...
LabConfigData = '{"path":"/Tim Wijers/pyATS_TestLabs/","name":"pyATSTestLab_8","version":"1","author":"Tim Wijers",' \
                '"description":"pyATS Test Lab 8","body":"This is a testlab created by the Eve-NG REST API. Intended ' \
...
NodeAddUrl = 'http://10.100.244.1/api/labs/Tim Wijers/pyATS_TestLabs/pyATSTestLab_8.unl/nodes'
...
NodeAddData = '{"type":"iol","template":"iol","config":"Saved","delay":0,"icon":"Router.png",' \
...
NetworkAddUrl = 'http://10.100.244.1/api/labs/Tim Wijers/pyATS_TestLabs/pyATSTestLab_8.unl/networks'
