...
setSSH_IOL('10.100.244.1'.encode('ascii'), '45569'.encode('ascii'), 'Router1'.encode('ascii'))
setSSH_IOL('10.100.244.1'.encode('ascii'), '45570'.encode('ascii'), 'Router2'.encode('ascii'))
setSSH_IOL('10.100.244.1'.encode('ascii'), '45571'.encode('ascii'), 'Router3'.encode('ascii'))
setSSH_IOL('10.100.244.1'.encode('ascii'), '45574'.encode('ascii'), 'Router5'.encode('ascii'))
